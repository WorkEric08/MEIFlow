...
As partes comprometem-se a manter em sigilo todas as informações confidenciais trocadas durante a execução deste contrato, incluindo dados técnicos, comerciais e estratégicos, pelo prazo de 2 (dois) anos após o término do contrato.`,n=`
## 7. Propriedade intelectual

Após o pagamento integral, todos os direitos patrimoniais sobre os entregáveis produzidos neste contrato são transferidos ao **CONTRATANTE**. O **CONTRATADO** mantém o direito de exibir o trabalho em seu portfólio, salvo solicitação expressa em contrário.`,o=`
## 8. Rescisão

Qualquer das partes pode rescindir este contrato mediante notificação escrita com antecedência mínima de 15 (quinze) dias. Em caso de rescisão pelo **CONTRATANTE** após o início dos trabalhos, será devida ao **CONTRATADO** a remuneração proporcional ao trabalho realizado até a data de rescisão.`,r=`
## 9. Foro

Fica eleito o foro da comarca de domicílio do **CONTRATADO** para dirimir quaisquer conflitos oriundos deste contrato, com renúncia a qualquer outro, por mais privilegiado que seja.`,d=[{id:"web-development",name:"Desenvolvimento de site / sistema",category:"Tecnologia",emoji:"💻",description:"Para quem cria sites, lojas online, sistemas ou aplicativos. Inclui prazos, entregas, suporte e propriedade do código.",content:`# Contrato de Prestação de Serviços de Desenvolvimento Web
...
**CONTRATADO:** {{contractor_name}}
Assinatura: ___________________________`},{id:"design",name:"Design e identidade visual",category:"Design",emoji:"🎨",description:"Para criação de logos, identidade visual, peças gráficas e interfaces. Inclui rodadas de revisão e direitos de uso.",content:`# Contrato de Prestação de Serviços de Design
...
**CONTRATADO:** {{contractor_name}}
Assinatura: ___________________________`},{id:"consultoria",name:"Consultoria e assessoria",category:"Serviços",emoji:"💡",description:"Para quem oferece consultoria, mentorias, assessoria ou orientações periódicas. Cobre escopo, reuniões e independência profissional.",content:`# Contrato de Consultoria
...
**CONTRATADO:** {{contractor_name}}
Assinatura: ___________________________`},{id:"fotografia",name:"Fotografia e captação de imagens",category:"Criativo",emoji:"📷",description:"Para fotógrafos: cobre data, local, entregáveis, tratamento de imagens e direitos de uso comercial.",content:`# Contrato de Serviços Fotográficos
...
**CONTRATADO:** {{contractor_name}}
Assinatura: ___________________________`}];function _(i,e){const s=e.end_date?`, com previsão de conclusão em **${e.end_date}**`:"",t=e.client_company?` — ${e.client_company}`:"";return i.replace(/{{client_name}}/g,e.client_name).replace(/{{client_company}}/g,t).replace(/{{contractor_name}}/g,e.contractor_name).replace(/{{project_name}}/g,e.project_name).replace(/{{value}}/g,e.value).replace(/{{start_date}}/g,e.start_date).replace(/{{end_date_clause}}/g,s).replace(/{{today}}/g,e.today)}export{d as C,_ as i};
